...
from util.loader import data_transformer_list_augmentation, load_yaml
...
def main():
    ...
    # Prepare dataloader
    transform = data_transformer_list_augmentation(mean_image, std_image, 
    ...
    batch_size = 8
    sample_interval = 400
    num_epochs = 30000  # Adjust as needed
    save_interval = 4000
